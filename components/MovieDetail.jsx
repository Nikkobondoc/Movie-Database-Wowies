...
function MovieDetail({ movie, favouriteComponent }) { // Correct the prop destructuring
  const dimensions = useWindowDimensions();
  const desktopWidth = 1440;
  let isDesktop = dimensions.width > desktopWidth;
  ...
  return (
    <div>
      ...
      <div className="movie-info-single">
        ...
        <AddFavourites /> {/* Use favouriteComponent directly */}
      </div>
    </div>
  );
}
